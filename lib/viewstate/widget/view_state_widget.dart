...
class ViewStateWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        image ?? Icon(ViewStateIcons.pageError, size: 80, color: Colors.grey[500]),
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                title ?? FunFlutterScaffoldLocalizations.of(context).viewStateMessageError,
                style: titleStyle,
              ),
              SizedBox(height: 20),
              ConstrainedBox(
...
class ViewStateButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlineButton(
      child: child ??
          Text(
            textData ?? FunFlutterScaffoldLocalizations.of(context).viewStateButtonRetry,
